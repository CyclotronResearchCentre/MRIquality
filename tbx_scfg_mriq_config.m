...
mriq_config.help    = {'Configure default parameters for the MRIquality toolbox.', ...
    ...
    ['Always run this module prior to any other module producing ' ...
    'outputs such as QA and automated QA, QA report, ...' ...
    'in order to properly define where outputs are saved.']};
