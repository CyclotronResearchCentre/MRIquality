...
NOISEseries.help      = {'EPI images acquired without RF.', ...
    ['The most reliable way to estimate SNR is to estimat noise from pure ' ...
...
noiplane.help    = {'Enter the number of the slice used to estimate the noise level.', ...
    ...
    'will be estimated based on ''background'' voxels selected using a ' ...
